            ...
            <div className="grid gap-px bg-[var(--line)] sm:grid-cols-2">
              <div className="bg-[var(--white)] p-5">
                ...
                <p className="mt-3 font-serif text-lg">
                  {project.district}, {project.preferredState || project.state}
                </p>
              </div>
              ...
              <div className="bg-[var(--white)] p-5">
                ...
                <p className="mt-3 font-serif text-lg">
                  {project.totalLandRequired || project.landArea} {project.landUnit || "Acres"}
                </p>
              </div>
              ...
              <div className="bg-[var(--white)] p-5">
                ...
                <p className="mt-3 font-serif text-lg">
                  {project.surveyPlotNumbers || project.parcels || "Not recorded"}
                </p>
              </div>
              ...
              <div className="bg-[var(--white)] p-5">
                ...
                <p className="mt-3 font-mono text-xs uppercase text-[var(--earth)]">
                  {project.fieldVerification?.status || "Not recorded"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              <div className="border-l-2 border-[var(--earth)] bg-[var(--paper)] p-5">
                ...
                <p className="mt-3 text-sm leading-7 text-[var(--ink)]">
                  {project.fieldVerification?.remarks || project.fieldVerificationRemarks ||
              ...
              <div className="mt-5 grid gap-3 border-t border-[var(--line)] pt-5 sm:grid-cols-2">
                <div>
                  <p className="font-mono text-[9px] uppercase tracking-wider text-[var(--ink-soft)]">Field Officer</p>
                  <p className="mt-1 text-sm">{project.fieldVerification?.officerId || "Not recorded"}</p>
                </div>
                <div>
                  <p className="font-mono text-[9px] uppercase tracking-wider text-[var(--ink-soft)]">Verified at</p>
                  <p className="mt-1 text-sm">
                    {project.fieldVerification?.verifiedAt ? new Date(project.fieldVerification.verifiedAt).toLocaleString() : "Not recorded"}
                  </p>
                </div>
                <div>
                  <p className="font-mono text-[9px] uppercase tracking-wider text-[var(--ink-soft)]">Coordinates</p>
                  <p className="mt-1 break-words text-sm">{project.fieldVerification?.coordinates ? JSON.stringify(project.fieldVerification.coordinates) : "Not recorded"}</p>
                </div>
                <div>
                  <p className="font-mono text-[9px] uppercase tracking-wider text-[var(--ink-soft)]">Photos</p>
                  {project.fieldVerification?.photos?.length ? (
                    <ul className="mt-1 space-y-1 text-sm">
                      {project.fieldVerification.photos.map((photo, index) => (
                        <li key={`${photo.name || "photo"}-${index}`}>{photo.name || `Photo ${index + 1}`}</li>
                      ))}
                    </ul>
                  ) : (
                    <p className="mt-1 text-sm">No photos submitted</p>
                  )}
                </div>
              </div>
