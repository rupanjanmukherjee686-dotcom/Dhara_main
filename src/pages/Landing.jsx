...
export default function Landing() {
  ...
  const authorityRoles = [
    ...
    },
    {
      id: "rehabilitation",
      number: "05",
      title: "Administrator for Rehabilitation and Resettlement",
      label: "Rehabilitation & Resettlement",
      description: "Monitor rehabilitation packages, resettlement obligations, affected families and compensation readiness.",
      icon: Users,
      color: "#b45309",
    },
  ]
  ...
  const openPortal = (portalId) => {
    if (portalId === "rehabilitation") {
      navigate("/signin/rehabilitation")
      return
    }
    if (portalId === "citizen") {
      navigate("/landowner")
