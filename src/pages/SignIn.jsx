...
const portalRoles = [
  ...
  {
    id: "rehabilitation",
    label: "Rehabilitation & Resettlement Administrator",
    description: "Monitor rehabilitation, resettlement and affected family obligations",
    type: "government",
    path: "/portal/rehabilitation",
    icon: Users,
  },
  {
    id: "citizen",
...
function SignIn({ initialRole: initialRoleProp }) {
  const navigate = useNavigate()
  const location = useLocation()

  const initialRole = initialRoleProp || location.state?.role || "company"
