            ...
            <div className="mb-5 flex items-end justify-between border-b border-[var(--line)] pb-4">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--ink-soft)]">
                  Field Officer findings are stored here for District Authority review before the project moves to State Authority.
                </p>
              </div>
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex items-center gap-2 text-xs text-[var(--ink-soft)]">
                          <MapPin size={13} />
                          {project.district || "District not recorded"}, {project.preferredState || project.state || "State not recorded"}
                        </div>
                    ...
                    <div className="mt-6 grid gap-4 border-t border-[var(--line)] pt-5 sm:grid-cols-4">
                      ...
                      <Detail
                        ...
                        value={`${project.totalLandRequired || project.landArea || "—"} ${project.landUnit || "Acres"}`}
                      />

                      <Detail
                        label="Parcels"
                        value={project.surveyPlotNumbers || project.parcels || "—"}
                      />

                      <Detail
                        label="Field decision"
                        value={project.fieldVerification?.status || "Verified"}
                      />

                      <Detail
                        label="Field officer"
                        value={project.fieldVerification?.officerId || "Not recorded"}
                      />
                    ...
                    <div className="mt-6 border-t border-[var(--line)] pt-5">
                      ...
                      <div className="mt-4 grid gap-3 text-xs sm:grid-cols-3">
                        <Detail
                          label="Verified at"
                          value={project.fieldVerification?.verifiedAt ? new Date(project.fieldVerification.verifiedAt).toLocaleString() : "Not recorded"}
                        />
                        <Detail
                          label="Photos submitted"
                          value={project.fieldVerification?.photos?.length || 0}
                        />
                        <Detail
                          label="Coordinates"
                          value={project.fieldVerification?.coordinates ? JSON.stringify(project.fieldVerification.coordinates) : "Not recorded"}
                        />
                      </div>
