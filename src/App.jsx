...
import RehabilitationDashboard from "./pages/RehabilitationDashboard"
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/signin/rehabilitation"
          element={<SignIn initialRole="rehabilitation" />}
        />
        ...
        <Route
          ...
          element={<ProtectedRoute><RehabilitationDashboard /></ProtectedRoute>}
        />
